...
public interface ClientRemote extends Remote {
    ...
    void play(int loc) throws RemoteException;
          void returnLoginState(boolean isLogged) throws RemoteException;
          void returnRegisterState(int  isRegistered) throws RemoteException;
          void returnUpdateState(int  isRegistered) throws RemoteException;
